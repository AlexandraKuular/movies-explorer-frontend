...
export const backendApiAddress = 'https://api.movies.alexkuular.nomoredomainsicu.ru';
...
export const infoMessages = {
  ...
  requestMoviesFaild: 'Во время запроса произошла ошибка. Возможно, проблема с соединением или сервер недоступен. Подождите немного и попробуйте ещё раз',
};
